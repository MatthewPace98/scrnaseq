...
genes <- c("Gsn", "Fabp4", "Actb", "Tmsb4x", "Dcn", "Acta1", "Tpt1", "Actg1", "Ubb", "Tpt1")

sc_RNAseq <- function(srt.data){
  srt <- CreateSeuratObject(counts = srt.data, project = "srt3k", min.cells = 3, min.features = 200)
